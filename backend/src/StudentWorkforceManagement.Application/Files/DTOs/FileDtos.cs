...
public sealed record FileUploadIntentDto(Guid FileId, string StorageKey, string FileName, long FileSize, string MimeType, string FileExtension, FileStatus Status);
