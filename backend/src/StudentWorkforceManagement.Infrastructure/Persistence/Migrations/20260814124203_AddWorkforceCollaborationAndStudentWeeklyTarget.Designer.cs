...
namespace StudentWorkforceManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260814124203_AddWorkforceCollaborationAndStudentWeeklyTarget")]
    partial class AddWorkforceCollaborationAndStudentWeeklyTarget
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentWorkforceManagement.Domain.Entities.ExportRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<long?>("ArtifactFileSize")
                        .HasColumnType("bigint");

                    b.Property<string>("ArtifactMimeType")
                        .HasMaxLength(150)
                    ...
                    b.ToTable("ExportRequests", null, t =>
                        {
                            t.HasCheckConstraint("CK_ExportRequests_ArtifactFileSize", "\"ArtifactFileSize\" IS NULL OR \"ArtifactFileSize\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("StudentWorkforceManagement.Domain.Entities.ExportRequest", b =>
                {
                    b.HasOne("StudentWorkforceManagement.Domain.Entities.User", "RequestingUser")
                        .WithMany()
