    ...
    : IRequestHandler<GetTaskRequestsQuery, PaginatedResult<TaskRequestDto>>
{
    public async System.Threading.Tasks.Task<PaginatedResult<TaskRequestDto>> Handle(GetTaskRequestsQuery request, CancellationToken cancellationToken)
    {
        ...
        return await query.OrderByDescending(entity => entity.CreatedAt)
            .Select(entity => new TaskRequestDto(entity.Id, entity.TaskId, entity.RequestedById, entity.Type, entity.Reason, entity.CurrentDeadline, entity.RequestedDeadline, entity.SuggestedStudentId, entity.Status, entity.CreatedAt, entity.ReviewedAt, entity.ReviewedById, entity.ReviewerComment, entity.ConcurrencyToken))
