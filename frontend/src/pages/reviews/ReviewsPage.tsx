              ...
              <>
                ...
                <form className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button iconBefore={<FileCheck2 aria-hidden="true" className="h-4 w-4" />} isLoading={mutations.approve.isPending} onClick={approve}>Approve</Button>
                    <Button variant="outline" iconBefore={<RotateCcw aria-hidden="true" className="h-4 w-4" />} isLoading={mutations.requestRevision.isPending} disabled={!comment.trim()} onClick={revision}>Request revision</Button>
                  </div>
                </form>
              </>
