...
public sealed record StudentDto(Guid Id, Guid UserId, string FirstName, string LastName, string Email, string Department, bool IsActive, DateTimeOffset CreatedAt, DateTimeOffset? UpdatedAt, Guid ConcurrencyToken);
